        ...
        <section class="section">
            <div class="container-fluid">
                ...
                <div class="card-style mb-30">
                    <h6 class="mb-25">Register Admin</h6>
                    <div class="card-body">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-auto">
                                ...
                                <input class="form-control" type="text" id="formFile" name="username" required>
                            ...
                            <div class="mb-3">
                                <div class="col-auto">
                                    ...
                                    <input class="form-control" type="password" id="formFile" name="password" required>
...
if (isset($_POST['register'])) {
    ...
    $result = "SELECT count(*) FROM admin WHERE username=?";
    ...
    if ($count > 0) {
        echo "<script>alert('Please Select different username');</script>";
    } else {
